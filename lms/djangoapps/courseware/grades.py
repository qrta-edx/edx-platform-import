...
@memoized
def block_types_affecting_grading():
    """
    Returns the block types that could have any impact on grading.
...
def possibly_scored(usage_key):
    ...
    """
    return usage_key.block_type in block_types_affecting_grading()
...
def grading_context(course_structure):
    ...
    all_scored_blocks - This contains a list of all blocks that can
    ...
    for chapter_key in course_structure.get_children(course_structure.root_block_usage_key):
        for section_key in course_structure.get_children(chapter_key):
            ...
            if section.graded:
                ...
                all_scored_blocks.extend(scored_descendants_of_section)

    return {
        'all_graded_sections': all_graded_sections,
        'all_scored_blocks': all_scored_blocks,
    }
        ...
        for section_info in sections:
            ...
            with outer_atomic():
                ...
                should_grade_section = any(
                    ...
                    for descendant in section['scored_descendants']
                )
...
def _progress_summary(student, request, course):
    ...
    # TODO - Create a gating_api transformer
    # TODO if section_module.hide_from_toc or unicode(section_module.location) in gated_content:
